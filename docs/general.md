...
This is a living document bookmark this page and check for updates at [https://handbook.dallasgivecamp.org](http://handbook.dallasgivecamp.org). Email questions to [contact@dallasgivecamp.org](mailto:contact@dallasgivecamp.org)
...
#### Volunteer Bootcamp
Wed 8/28/2019 6:30 PM to 8:00 PM: Learning session on the ins and out of GiveCamp whether you are a returning volunteer or new.  It’s a great opportunity to learn about the charities that we will be helping this year as well as an overview of the technology we will be using.
